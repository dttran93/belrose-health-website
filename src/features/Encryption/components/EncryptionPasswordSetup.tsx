...
import InputField from '@/components/auth/components/ui/InputField';
        ...
        <div className="border-t pt-4">
          <label className="flex items-start space-x-3 cursor-pointer">
            ...
            <span className="text-sm">
              ...
              I cannot recover my data if I forget my encryption password.
            </span>
          </label>
        </div>
  ...
  return (
    <div className="bg-white rounded-lg max-w-md w-full p-6 space-y-4">
      ...
      <div className="flex space-x-3 pt-4">
        {onCancel && (
          <Button variant="outline" onClick={onCancel} className="flex-1 px-4 py-2">
            Cancel
          </Button>
        )}
        <Button
          ...
          className={`flex-1 px-4 py-2 rounded-lg font-semibold ${
            canProceed && !isSubmitting ? '' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
          }`}
        >
