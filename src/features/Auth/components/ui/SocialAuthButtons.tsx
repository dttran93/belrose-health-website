...
export const SocialAuthButtons: React.FC<SocialAuthButtonsProps> = ({ disabled = false }) => {
  const { isLoading, handleGoogleSignIn, handleFacebookSignIn, handleGitHubSignIn } =
    useSocialAuth();
