    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          type={type}
          className={cn(
            'w-full py-3 border bg-background rounded-xl focus:border-none focus:outline-none focus:ring-1 focus:ring-primary focus:border-none transition-all placeholder-gray-400',
