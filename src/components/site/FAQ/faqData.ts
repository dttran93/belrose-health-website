...
export const faqs: FAQData = {
  ...
  'The Belrose Protocol': [
    ...
    },
    {
      ...
      a: 'We have zero-retention agreements signed with all of the AI labs we use to process data. We are also planning to run open source models on our own to give you the option of maximum privacy.',
    },
    {
      q: 'What is a distributed network?',
      a: 'When we say distributed network, we are refering to a shared, digital ledger that records data securely, chronologically, and permanently across a decentralized network comprised of thousands of computers around the world. This technology is commonly referred to as a blockchain. But that term has a lot of baggage so we stick to calling it a distributed network.',
    },
    {
