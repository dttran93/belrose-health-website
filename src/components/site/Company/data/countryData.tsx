  ...
  },
  {
    ...
    content: (
      <>
        {' '}
        <p className="text-left mb-4">
          In 2002, the German government set an ambitious goal: a smart healthcard for every citizen
          by 2006, spearheaded by Gematik GmbH. For a decade the only thing Gematik succeeded in
          producing was a card that stored your name and insurance status, no records
        ...
        <p className="text-left mb-4">
          ...
          Club uncovered ePa vulnerabilites that allowed them to access millions of records
    ...
    content: (
      <>
        <p className="text-left mb-4">
          ...
          a service called Journalen. By many measures it is genuinely good - its the #1 medical app
    ...
    content: (
      <>
        ...
        <p className="text-left mb-4">
          ...
          from an overemphasis on indivdiualism, privacy, and skepticism. Japan with its universal
        ...
        <p className="text-left mb-4">
          ...
          <CitationLink id="jp-errors" />. In 5 cases, patients visting clinics found themselves
          viewing other people's prescriptions and medical expenses <CitationLink id="jp-errors2" />
          . The government correctly noted the error rate was just 0.01% across 82 million records.
          But for the Japanese public, this validated long standing concerns around health data
        ...
        <p className="text-left mb-4">
          ...
          harmony, not even a third of citizens trusts the government to centralize their health
    ...
    content: (
      <>
        ...
        <p className="text-left mb-4">
          ...
          delegated the task to private markets. The result, a monstrous mix of private predatory
          market practices and public institutional data abuse.
        </p>
        <p className="text-left mb-4">
          ...
          prohibitively expensive for hospitals to leave. The 21st Century CURES Act was required to
          forced these companies to build interoperability APIs
          <CitationLink id="cures-act" />. Governments and businesses bicker while the patient,
          whose data is the center of all this, has no seat at the table.
        </p>
        <p className="text-left mb-4">
          Another risk of centralization reveals itself in the US's public insurance system.
          Medicare and Medicaid aggregates health data for over 100 million Americans for whom it
          pays for healthcare. 20 states are now grappling with this centralization as they sue the
  ...
  },
  {
    ...
    content: (
      <>
        {' '}
        <p className="text-left mb-4">
          Estonia is the steel-man case for record centralization. Its system works. Nearly 100% of
    ...
    content: (
      <>
        <p className="text-left mb-4">
          ...
          well-funded, technically sound, and politicallly supported.
        </p>
        <p className="text-left mb-4">
          ...
          restrictions, those restrictions can be overriden by doctors
