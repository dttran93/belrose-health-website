    ...
    <section className="px-8 md:px-[10vw] py-16 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d158858.5868698898!2d-0.266747080689981!3d51.528525721412336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon!5e0!3m2!1sen!2suk!4v1772102796182!5m2!1sen!2suk"
              width="400"
              height="300"
              style={{ border: 0 }}
              allowFullScreen
