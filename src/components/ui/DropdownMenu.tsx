...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    ...
    >
      ...
      {isOpen && <div className="absolute top-full left-0 right-0 h-4 bg-transparent" />}

      {/* Dropdown content */}
      <div
        className={`fixed left-0 top-full w-full bg-background/80 border-t border-gray-200 shadow-lg z-50 transition-all duration-300 ease-in-out ${
          isOpen
