...
exports.sendPasswordChangeEmail = void 0;
...
exports.sendPasswordChangeEmail = (0, https_1.onCall)({ secrets: [resendKey] }, async (request) => {
    if (!request.auth) {
...
// ── Email templates ───────────────────────────────────────────────────────────
function buildPasswordChangeHtml(displayName) {
...
function buildPasswordChangeText(displayName) {
    const supportEmail = 'support@belrosehealth.com';
    const recoveryLink = 'https://belrosehealth.com/auth/recover';
    return `
...
//# sourceMappingURL=sendPasswordChangeEmail.js.map