...
exports.buildSubjectRequestHtml = buildSubjectRequestHtml;
exports.buildSubjectRequestText = buildSubjectRequestText;
exports.buildSubjectAcceptedHtml = buildSubjectAcceptedHtml;
exports.buildSubjectAcceptedText = buildSubjectAcceptedText;
exports.buildSubjectDeclinedHtml = buildSubjectDeclinedHtml;
exports.buildSubjectDeclinedText = buildSubjectDeclinedText;
exports.buildSubjectRemovedHtml = buildSubjectRemovedHtml;
exports.buildSubjectRemovedText = buildSubjectRemovedText;
exports.buildCreatorResponseHtml = buildCreatorResponseHtml;
exports.buildCreatorResponseText = buildCreatorResponseText;
...
function footer() {
    ...
    <div style="padding:24px 40px;background:#f8fafc;border-top:1px solid #e2e8f0;
      ...
      <p style="margin:0 0 6px;font-size:12px;color:#94a3b8;">
        Questions? <a href="mailto:${emailUtils_1.SUPPORT_EMAIL}" style="color:#3b82f6;
        text-decoration:none;">${emailUtils_1.SUPPORT_EMAIL}</a>
      </p>
...
function buildCreatorResponseText(recordName, recordId, escalated) {
...
//# sourceMappingURL=subjectEmailTemplates.js.map