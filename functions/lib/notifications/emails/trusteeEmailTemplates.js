...
function buildTrusteeInvitedHtml(trustorName, levelLabel, levelDescription) {
    ...
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${emailUtils_1.APP_URL}/settings?tab=my-trustors`, 'Review invite', '#8b5cf6')}
    </div>
    ${footer()}
  `);
}
...
Review the invite at: ${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustors
...
function buildTrusteeAcceptedHtml(trusteeName, levelLabel) {
    ...
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustees`, 'Manage trustees', '#22c55e')}
    </div>
    ${footer()}
  `);
}
...
Manage your trustees at: ${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustees
...
function buildTrusteeDeclinedHtml(trusteeName, levelLabel) {
    ...
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustees`, 'Manage trustees', '#f59e0b')}
    </div>
    ${footer()}
  `);
}
...
You can invite someone else from your trustees page: ${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustees
...
function buildTrusteeRevokedHtml(trustorName, levelLabel) {
    ...
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustors`, 'View your trustees', '#ef4444')}
    </div>
    ${footer()}
  `);
}
...
View your trustees at: ${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustors
...
function buildTrusteeLevelChangedHtml(trustorName, prevLabel, newLabel, newDescription, isUpgrade) {
    ...
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustors`, 'View trustee relationships', badgeColor)}
    </div>
    ${footer()}
  `);
}
...
View your trustee relationships at: ${emailUtils_1.APP_URL}/settings/trustees?tab=my-trustors
