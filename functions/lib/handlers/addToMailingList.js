...
exports.addToMailingList = void 0;
...
// CALLABLE FUNCTION
// ============================================================================
exports.addToMailingList = (0, https_1.onCall)({ secrets: [resendKey] }, async (request) => {
    ...
    if (!source) {
        throw new https_1.HttpsError('invalid-argument', 'Source is required.');
    }
    if (!consentText) {
        throw new https_1.HttpsError('invalid-argument', 'Consent text is required.');
    }
    ...
    await resend.emails.send({
        to: normalised,
        from: `${emailUtils_1.FROM_NAME} <${emailUtils_1.FROM_EMAIL}>`,
        subject: "You're on our list — here's what we're building at Belrose",
        html: buildMailingListEmailHtml(emailUtils_1.MARKETING_URL),
        text: buildMailingListEmailText(emailUtils_1.MARKETING_URL),
    });
...
//# sourceMappingURL=addToMailingList.js.map