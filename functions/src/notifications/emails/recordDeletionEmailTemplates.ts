...
export function buildRecordDeletedHtml(deleterName: string, recordName: string): string {
    ...
    <div style="padding:32px 40px;">
      ...
      <div style="background:#fef2f2;border:1px solid #fecaca;border-radius:10px;
        ...
        <p style="margin:0;font-size:13px;color:#7f1d1d;line-height:1.6;">
            If you believe this was a mistake please reach out to ${deleterName} or contact us at ${SUPPORT_EMAIL}.
        </p>
      </div>

      <div style="text-align:center;">
        <a href="${APP_URL}/records" style="display:inline-block;background:#0f172a;color:#fff;
...
export function buildRecordDeletedText(deleterName: string, recordName: string): string {
  return `${deleterName} has deleted "${recordName}".

You no longer have access to this record or its contents. If you believe this was a mistake please reach out to ${SUPPORT_EMAIL} 
