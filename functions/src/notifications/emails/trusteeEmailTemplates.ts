...
export function buildTrusteeInvitedHtml(
  trustorName: string,
  levelLabel: string,
  ...
  return wrap(`
    ${header(
      'Trustee invite',
      '#8b5cf6',
      `${trustorName} invited you to be their trustee`,
      `You've been invited as a ${levelLabel} trustee`
    )}
    <div style="padding:32px 40px;">
      ...
      ${ctaButton(`${APP_URL}/settings?tab=my-trustors`, 'Review invite', '#8b5cf6')}
    </div>
    ${footer()}
  `);
}

export function buildTrusteeInvitedText(
  trustorName: string,
  levelLabel: string,
  levelDescription: string
): string {
...
Review the invite at: ${APP_URL}/settings/trustees?tab=my-trustors
...
export function buildTrusteeAcceptedHtml(trusteeName: string, levelLabel: string): string {
  return wrap(`
    ${header(
      'Invite accepted',
      '#22c55e',
      `${trusteeName} is now your trustee`,
      `${trusteeName} accepted your ${levelLabel} trustee invite`
    )}
    <div style="padding:32px 40px;">
      <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#3f3f46;">
      ...
      ${ctaButton(`${APP_URL}/settings/trustees?tab=my-trustees`, 'Manage trustees', '#22c55e')}
    </div>
    ${footer()}
  `);
}

export function buildTrusteeAcceptedText(trusteeName: string, levelLabel: string): string {
  return `${trusteeName} accepted your ${levelLabel} trustee invite and is now active on your account.

Manage your trustees at: ${APP_URL}/settings/trustees?tab=my-trustees
...
export function buildTrusteeDeclinedHtml(trusteeName: string, levelLabel: string): string {
  return wrap(`
    ${header(
      'Invite declined',
      '#f59e0b',
      `${trusteeName} declined your invite`,
      `Your ${levelLabel} trustee invite was not accepted`
    )}
    <div style="padding:32px 40px;">
      <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#3f3f46;">
      ...
      ${ctaButton(`${APP_URL}/settings/trustees?tab=my-trustees`, 'Manage trustees', '#f59e0b')}
    </div>
    ${footer()}
  `);
}

export function buildTrusteeDeclinedText(trusteeName: string, levelLabel: string): string {
  return `${trusteeName} declined your ${levelLabel} trustee invite.

You can invite someone else from your trustees page: ${APP_URL}/settings/trustees?tab=my-trustees
...
export function buildTrusteeRevokedHtml(trustorName: string, levelLabel: string): string {
  return wrap(`
    ${header(
      'Access revoked',
      '#ef4444',
      'Your trustee access has been revoked',
      `${trustorName} removed your ${levelLabel} trustee status`
    )}
    <div style="padding:32px 40px;">
      <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#3f3f46;">
      ...
      ${ctaButton(`${APP_URL}/settings/trustees?tab=my-trustors`, 'View your trustees', '#ef4444')}
    </div>
    ${footer()}
  `);
}

export function buildTrusteeRevokedText(trustorName: string, levelLabel: string): string {
...
View your trustees at: ${APP_URL}/settings/trustees?tab=my-trustors
...
export function buildTrusteeResignedHtml(trusteeName: string, levelLabel: string): string {
  return wrap(`
    ${header(
      'Trustee resigned',
      '#f59e0b',
      `${trusteeName} has resigned`,
      `Your ${levelLabel} trustee stepped down`
    )}
    <div style="padding:32px 40px;">
      <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#3f3f46;">
...
export function buildTrusteeResignedText(trusteeName: string, levelLabel: string): string {
...
export function buildTrusteeLevelChangedHtml(
  trustorName: string,
  prevLabel: string,
  newLabel: string,
  ...
  return wrap(`
    ${header(
      `Level ${action}`,
      badgeColor,
      `Your trustee level was ${action}`,
      `${trustorName} ${action} your trust level from ${prevLabel} to ${newLabel}`
    )}
    <div style="padding:32px 40px;">
      <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#3f3f46;">
      ...
      ${ctaButton(`${APP_URL}/settings/trustees?tab=my-trustors`, 'View trustee relationships', badgeColor)}
    </div>
    ${footer()}
  `);
}

export function buildTrusteeLevelChangedText(
  trustorName: string,
  prevLabel: string,
  newLabel: string,
  isUpgrade: boolean
...
View your trustee relationships at: ${APP_URL}/settings/trustees?tab=my-trustors
